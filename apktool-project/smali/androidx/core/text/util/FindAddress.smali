...
.method private static isValidZipCode(Ljava/lang/String;Ljava/util/regex/MatchResult;)Z
    ...
    .line 6
    iget v1, p1, Landroidx/core/text/util/FindAddress$ZipRange;->mLow:I

    if-gt v1, p0, :cond_3

    iget v1, p1, Landroidx/core/text/util/FindAddress$ZipRange;->mHigh:I

    if-le p0, v1, :cond_5

    :cond_3
    iget v1, p1, Landroidx/core/text/util/FindAddress$ZipRange;->mException1:I

    if-eq p0, v1, :cond_5

    iget p1, p1, Landroidx/core/text/util/FindAddress$ZipRange;->mException2:I
