...
.field public mPlayerCallbacks:Ljava/util/ArrayList;
...
.method public final getPlayerCallbacks()Ljava/util/List;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public final setHost(Landroidx/leanback/media/PlaybackGlueHost;)V
    ...
    .line 2
    iget-object v2, v0, Landroidx/leanback/media/PlaybackGlueHost;->mGlue:Landroidx/leanback/media/PlaybackGlue;

    if-eqz v2, :cond_1

    .line 3
    invoke-virtual {v2}, Landroidx/leanback/media/PlaybackGlue;->onDetachedFromHost()V

    .line 4
    :cond_1
    iput-object v1, v0, Landroidx/leanback/media/PlaybackGlueHost;->mGlue:Landroidx/leanback/media/PlaybackGlue;
    ...
    .line 6
    iget-object v0, p1, Landroidx/leanback/media/PlaybackGlueHost;->mGlue:Landroidx/leanback/media/PlaybackGlue;
    ...
    .line 8
    :cond_3
    iput-object p0, p1, Landroidx/leanback/media/PlaybackGlueHost;->mGlue:Landroidx/leanback/media/PlaybackGlue;

    .line 9
    invoke-virtual {p0, p1}, Landroidx/leanback/media/PlaybackGlue;->onAttachedToHost(Landroidx/leanback/media/PlaybackGlueHost;)V
