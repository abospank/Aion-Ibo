...
.method private static final parseDuration(Ljava/lang/String;Z)J
    ...
    .line 4
    invoke-static/range {p0 .. p0}, Lkotlin/text/StringsKt;->startsWith$default(Ljava/lang/CharSequence;)Z
    ...
    .line 9
    new-instance v9, Lkotlin/ranges/CharRange;
    ...
    invoke-direct {v9, v7, v10}, Lkotlin/ranges/CharRange;-><init>(CC)V

    invoke-virtual {v9, v8}, Lkotlin/ranges/CharRange;->contains(C)Z
    ...
    invoke-static {v7, v8}, Lkotlin/text/StringsKt;->contains$default(Ljava/lang/CharSequence;C)Z
    ...
    .line 14
    invoke-static {v5, v2}, Lkotlin/time/DurationUnitKt__DurationUnitKt;->durationUnitByIsoChar(CZ)Lkotlin/time/DurationUnit;
    ...
    .line 16
    invoke-static {v6, v9, v10, v8}, Lkotlin/text/StringsKt;->indexOf$default(Ljava/lang/CharSequence;CII)I
    ...
    .line 23
    invoke-static {v1, v6}, Landroidx/core/graphics/Insets$$ExternalSyntheticOutline0;->m(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v5, v7}, Lkotlin/text/StringsKt;->regionMatches(Ljava/lang/String;II)Z
    ...
    invoke-virtual {v8, v7}, Lkotlin/ranges/CharRange;->contains(C)Z
    ...
    invoke-direct {v9, v10, v2}, Lkotlin/ranges/CharRange;-><init>(CC)V
    ...
    .line 43
    invoke-static {v6, v8, v9, v7}, Lkotlin/text/StringsKt;->indexOf$default(Ljava/lang/CharSequence;CII)I
    ...
    invoke-static {v6, v7, v2}, Lkotlin/time/DurationKt;->toDuration(DLkotlin/time/DurationUnit;)J
...
.method private static final parseOverLongIsoComponent(Ljava/lang/String;)J
    ...
    invoke-static {p0}, Lkotlin/text/StringsKt;->drop(Ljava/lang/String;)Ljava/lang/String;
