...
.method public final getMediaCodecConfiguration(Lcom/google/android/exoplayer2/mediacodec/MediaCodecInfo;Lcom/google/android/exoplayer2/Format;Landroid/media/MediaCrypto;F)Lcom/google/android/exoplayer2/mediacodec/MediaCodecAdapter$Configuration;
    ...
    .line 6
    invoke-direct {p0, p1, v6}, Lcom/google/android/exoplayer2/audio/MediaCodecAudioRenderer;->getCodecMaxInputSize(Lcom/google/android/exoplayer2/mediacodec/MediaCodecInfo;Lcom/google/android/exoplayer2/Format;)I
    ...
    invoke-static {v2, v0}, Lcom/google/android/exoplayer2/util/MediaFormatUtil;->setCsdBuffers(Landroid/media/MediaFormat;Ljava/util/List;)V

    const-string v0, "max-input-size"

    .line 15
    invoke-static {v2, v0, v1}, Lcom/google/android/exoplayer2/util/MediaFormatUtil;->maybeSetInteger(Landroid/media/MediaFormat;Ljava/lang/String;I)V
    ...
    .line 19
    invoke-virtual {v2, v1, p4}, Landroid/media/MediaFormat;->setFloat(Ljava/lang/String;F)V
    ...
    .line 21
    invoke-virtual {v2, p4, v4}, Landroid/media/MediaFormat;->setInteger(Ljava/lang/String;I)V
    ...
    .line 22
    iget-object p4, p0, Lcom/google/android/exoplayer2/audio/MediaCodecAudioRenderer;->audioSink:Lcom/google/android/exoplayer2/audio/AudioSink;

    iget v1, p2, Lcom/google/android/exoplayer2/Format;->channelCount:I

    iget v5, p2, Lcom/google/android/exoplayer2/Format;->sampleRate:I

    const/4 v6, 0x4

    .line 23
    invoke-static {v6, v1, v5}, Lcom/google/android/exoplayer2/util/Util;->getPcmFormat(III)Lcom/google/android/exoplayer2/Format;

    move-result-object v1

    .line 24
    invoke-interface {p4, v1}, Lcom/google/android/exoplayer2/audio/AudioSink;->getFormatSupport(Lcom/google/android/exoplayer2/Format;)I
    ...
    .line 25
    invoke-virtual {v2, p4, v6}, Landroid/media/MediaFormat;->setInteger(Ljava/lang/String;I)V
    ...
    .line 27
    :cond_6
    iget-object p4, p1, Lcom/google/android/exoplayer2/mediacodec/MediaCodecInfo;->mimeType:Ljava/lang/String;
...
.method public final onOutputStreamOffsetUsChanged(J)V
    .locals 1
...
.method public final supportsFormat(Lcom/google/android/exoplayer2/mediacodec/MediaCodecSelector;Lcom/google/android/exoplayer2/Format;)I
    ...
    .line 5
    iget-object v8, p0, Lcom/google/android/exoplayer2/audio/MediaCodecAudioRenderer;->audioSink:Lcom/google/android/exoplayer2/audio/AudioSink;

    .line 6
    invoke-interface {v8, p2}, Lcom/google/android/exoplayer2/audio/AudioSink;->supportsFormat(Lcom/google/android/exoplayer2/Format;)Z
    ...
    .line 8
    :cond_5
    invoke-static {v7, v6, v0}, Lcom/google/android/exoplayer2/RendererCapabilities$-CC;->create(III)I
    ...
    iget-object v4, p0, Lcom/google/android/exoplayer2/audio/MediaCodecAudioRenderer;->audioSink:Lcom/google/android/exoplayer2/audio/AudioSink;
    ...
    .line 12
    invoke-static {v5, v8, v9}, Lcom/google/android/exoplayer2/util/Util;->getPcmFormat(III)Lcom/google/android/exoplayer2/Format;

    move-result-object v8

    .line 13
    invoke-interface {v4, v8}, Lcom/google/android/exoplayer2/audio/AudioSink;->supportsFormat(Lcom/google/android/exoplayer2/Format;)Z
    ...
    .line 16
    invoke-static {p1, p2, v1, v4}, Lcom/google/android/exoplayer2/audio/MediaCodecAudioRenderer;->getDecoderInfos(Lcom/google/android/exoplayer2/mediacodec/MediaCodecSelector;Lcom/google/android/exoplayer2/Format;ZLcom/google/android/exoplayer2/audio/AudioSink;)Ljava/util/List;
    ...
    .line 27
    :cond_10
    invoke-static {v7, v6, v0, p2, v1}, Lcom/google/android/exoplayer2/RendererCapabilities$-CC;->create(IIIII)I
