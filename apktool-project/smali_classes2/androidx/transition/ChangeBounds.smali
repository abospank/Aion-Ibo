...
.method public createAnimator(Landroid/view/ViewGroup;Landroidx/transition/TransitionValues;Landroidx/transition/TransitionValues;)Landroid/animation/Animator;
    ...
    .line 21
    invoke-static {v3, v8, v9, v12, v1}, Landroidx/transition/ViewUtils;->setLeftTopRightBottom(Landroid/view/View;IIII)V
    ...
    .line 28
    invoke-static {v2, v6, v7, v4}, Landroid/animation/ObjectAnimator;->ofObject(Ljava/lang/Object;Landroid/util/Property;Landroid/animation/TypeConverter;Landroid/graphics/Path;)Landroid/animation/ObjectAnimator;
    ...
    invoke-virtual {v6, v8, v1, v9, v5}, Landroidx/transition/PathMotion;->getPath(FFFF)Landroid/graphics/Path;
    ...
    .line 31
    invoke-static {v2, v5, v7, v1}, Landroid/animation/ObjectAnimator;->ofObject(Ljava/lang/Object;Landroid/util/Property;Landroid/animation/TypeConverter;Landroid/graphics/Path;)Landroid/animation/ObjectAnimator;
    ...
    .line 43
    invoke-static {v3, v8, v9, v1, v12}, Landroidx/transition/ViewUtils;->setLeftTopRightBottom(Landroid/view/View;IIII)V
    ...
    invoke-virtual {v1, v8, v9, v12, v14}, Landroidx/transition/PathMotion;->getPath(FFFF)Landroid/graphics/Path;
    ...
    .line 46
    invoke-static {v3, v8, v9, v1}, Landroid/animation/ObjectAnimator;->ofObject(Ljava/lang/Object;Landroid/util/Property;Landroid/animation/TypeConverter;Landroid/graphics/Path;)Landroid/animation/ObjectAnimator;
    ...
    invoke-direct {v2, v8, v8, v15, v6}, Landroid/graphics/Rect;-><init>(IIII)V
    ...
    invoke-direct {v6, v8, v8, v7, v4}, Landroid/graphics/Rect;-><init>(IIII)V
    ...
    invoke-static {v3, v2, v4, v0}, Landroid/animation/ObjectAnimator;->ofObject(Ljava/lang/Object;Ljava/lang/String;Landroid/animation/TypeEvaluator;[Ljava/lang/Object;)Landroid/animation/ObjectAnimator;
    ...
    .line 53
    :goto_8
    invoke-static {v1, v4}, Landroidx/transition/TransitionUtils;->mergeAnimators(Landroid/animation/Animator;Landroid/animation/Animator;)Landroid/animation/Animator;
    ...
    .line 69
    invoke-static {v0, v9}, Landroidx/transition/ViewUtils;->setTransitionAlpha(Landroid/view/View;F)V
    ...
    .line 71
    invoke-interface {v9, v8}, Landroidx/transition/ViewOverlayImpl;->add(Landroid/graphics/drawable/Drawable;)V
