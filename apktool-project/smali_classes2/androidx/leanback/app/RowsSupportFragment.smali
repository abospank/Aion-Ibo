...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/leanback/app/RowsSupportFragment;->mSelectAnimatorInterpolator:Landroid/view/animation/DecelerateInterpolator;
...
.method public static setRowViewSelected(Landroidx/leanback/widget/ItemBridgeAdapter$ViewHolder;ZZ)V
    ...
    .line 5
    iget-object p2, v0, Landroidx/leanback/app/RowsSupportFragment$RowViewHolderExtra;->this$0:Landroidx/leanback/app/RowsSupportFragment;

    iget v2, p2, Landroidx/leanback/app/RowsSupportFragment;->mSelectAnimatorDuration:I

    iput v2, v0, Landroidx/leanback/app/RowsSupportFragment$RowViewHolderExtra;->mSelectAnimatorDurationInUse:I

    .line 6
    iget-object p2, p2, Landroidx/leanback/app/RowsSupportFragment;->mSelectAnimatorInterpolator:Landroid/view/animation/DecelerateInterpolator;

    iput-object p2, v0, Landroidx/leanback/app/RowsSupportFragment$RowViewHolderExtra;->mSelectAnimatorInterpolatorInUse:Landroid/view/animation/DecelerateInterpolator;
...
.method public final onRowSelected(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;II)V
    ...
    iget v3, p0, Landroidx/leanback/app/RowsSupportFragment;->mSubPosition:I

    if-eq v3, p3, :cond_2

    .line 2
    :cond_0
    iput p3, p0, Landroidx/leanback/app/RowsSupportFragment;->mSubPosition:I

    if-eqz v0, :cond_1

    .line 3
    invoke-static {v0, v1, v1}, Landroidx/leanback/app/RowsSupportFragment;->setRowViewSelected(Landroidx/leanback/widget/ItemBridgeAdapter$ViewHolder;ZZ)V

    .line 4
    :cond_1
    check-cast p1, Landroidx/leanback/widget/ItemBridgeAdapter$ViewHolder;

    iput-object p1, p0, Landroidx/leanback/app/RowsSupportFragment;->mSelectedViewHolder:Landroidx/leanback/widget/ItemBridgeAdapter$ViewHolder;

    if-eqz p1, :cond_2

    .line 5
    invoke-static {p1, v2, v1}, Landroidx/leanback/app/RowsSupportFragment;->setRowViewSelected(Landroidx/leanback/widget/ItemBridgeAdapter$ViewHolder;ZZ)V
    ...
    :cond_3
    invoke-interface {p1, v1}, Landroidx/leanback/app/BrowseSupportFragment$FragmentHost;->showTitleView(Z)V
...
.method public setSelectedPosition(IZLandroidx/leanback/widget/Presenter$ViewHolderTask;)V
    ...
    invoke-direct {v1, p3}, Landroidx/leanback/app/RowsSupportFragment$2;-><init>(Landroidx/leanback/widget/Presenter$ViewHolderTask;)V
