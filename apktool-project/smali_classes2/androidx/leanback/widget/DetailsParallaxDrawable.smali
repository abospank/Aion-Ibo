...
.method public final init(Landroid/content/Context;Landroidx/leanback/widget/DetailsParallax;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroidx/leanback/widget/ParallaxTarget;)V
    .locals 4
    ...
    sget v1, Landroidx/leanback/R$dimen;->lb_details_v2_align_pos_for_actions:I
    ...
    sget v1, Landroidx/leanback/R$dimen;->lb_details_v2_align_pos_for_description:I
    ...
    new-array v2, v1, [Landroidx/leanback/widget/Parallax$PropertyMarkerValue;

    .line 13
    invoke-virtual {p3, v0}, Landroidx/leanback/widget/Parallax$IntProperty;->atAbsolute(I)Landroidx/leanback/widget/Parallax$PropertyMarkerValue;
    ...
    invoke-virtual {p3, p1}, Landroidx/leanback/widget/Parallax$IntProperty;->atAbsolute(I)Landroidx/leanback/widget/Parallax$PropertyMarkerValue;
    ...
    invoke-virtual {p2, v2}, Landroidx/leanback/widget/Parallax;->addEffect([Landroidx/leanback/widget/Parallax$PropertyMarkerValue;)Landroidx/leanback/widget/ParallaxEffect;

    move-result-object p1

    .line 14
    invoke-virtual {p1, p5}, Landroidx/leanback/widget/ParallaxEffect;->target(Landroidx/leanback/widget/ParallaxTarget;)Landroidx/leanback/widget/ParallaxEffect;

    new-array p1, v1, [Landroidx/leanback/widget/Parallax$PropertyMarkerValue;

    .line 15
    invoke-virtual {p4}, Landroidx/leanback/widget/Parallax$IntProperty;->atMax()Landroidx/leanback/widget/Parallax$PropertyMarkerValue;

    move-result-object p5

    aput-object p5, p1, v3

    invoke-virtual {p4}, Landroidx/leanback/widget/Parallax$IntProperty;->atMin()Landroidx/leanback/widget/Parallax$PropertyMarkerValue;
    ...
    sget-object p5, Landroidx/leanback/graphics/CompositeDrawable$ChildDrawable;->TOP_ABSOLUTE:Landroid/util/Property;

    invoke-virtual {p1, p4, p5}, Landroidx/leanback/widget/ParallaxEffect;->target(Ljava/lang/Object;Landroid/util/Property;)Landroidx/leanback/widget/ParallaxEffect;

    new-array p1, v1, [Landroidx/leanback/widget/Parallax$PropertyMarkerValue;

    .line 17
    invoke-virtual {p3}, Landroidx/leanback/widget/Parallax$IntProperty;->atMax()Landroidx/leanback/widget/Parallax$PropertyMarkerValue;

    move-result-object p4

    aput-object p4, p1, v3

    invoke-virtual {p3}, Landroidx/leanback/widget/Parallax$IntProperty;->atMin()Landroidx/leanback/widget/Parallax$PropertyMarkerValue;
    ...
    .line 18
    invoke-virtual {p0, v3}, Landroidx/leanback/graphics/CompositeDrawable;->getChildAt(I)Landroidx/leanback/graphics/CompositeDrawable$ChildDrawable;
