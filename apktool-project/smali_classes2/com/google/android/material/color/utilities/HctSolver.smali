...
.method public static solveToInt(DDD)I
    ...
    .line 4
    sget-object v8, Lcom/google/android/material/color/utilities/ViewingConditions;->DEFAULT:Lcom/google/android/material/color/utilities/ViewingConditions;

    .line 5
    invoke-virtual {v8}, Lcom/google/android/material/color/utilities/ViewingConditions;->getN()D
    ...
    const-wide v17, 0x40ae0c4ec4ec4ec5L    # 3846.153846153846

    mul-double v15, v15, v17

    .line 7
    invoke-virtual {v8}, Lcom/google/android/material/color/utilities/ViewingConditions;->getNc()D

    move-result-wide v17

    mul-double v17, v17, v15

    invoke-virtual {v8}, Lcom/google/android/material/color/utilities/ViewingConditions;->getNcb()D
    ...
    cmpl-double v28, p2, v22

    if-eqz v28, :cond_2

    cmpl-double v28, v4, v22
    ...
    .line 12
    invoke-virtual {v8}, Lcom/google/android/material/color/utilities/ViewingConditions;->getAw()D

    move-result-wide v14

    .line 13
    invoke-virtual {v8}, Lcom/google/android/material/color/utilities/ViewingConditions;->getC()D
    ...
    invoke-virtual {v8}, Lcom/google/android/material/color/utilities/ViewingConditions;->getZ()D

    move-result-wide v32

    move-wide/from16 v34, v9

    div-double v9, v30, v32
    ...
    .line 14
    invoke-virtual {v8}, Lcom/google/android/material/color/utilities/ViewingConditions;->getNbb()D
    ...
    .line 17
    invoke-static {v6, v7}, Lcom/google/android/material/color/utilities/HctSolver;->inverseChromaticAdaptation(D)D
    ...
    .line 18
    sget-object v6, Lcom/google/android/material/color/utilities/HctSolver;->LINRGB_FROM_SCALED_DISCOUNT:[[D

    .line 19
    invoke-static {v15, v6}, Lcom/google/android/material/color/utilities/MathUtils;->matrixMultiply([D[[D)[D
    ...
    .line 21
    :cond_3
    sget-object v7, Lcom/google/android/material/color/utilities/HctSolver;->Y_FROM_LINRGB:[D
    ...
    .line 23
    aget-wide v36, v7, v10

    .line 24
    aget-wide v26, v6, v21
    ...
    const-wide v7, 0x405900a3d70a3d71L    # 100.01
    ...
    .line 27
    :cond_7
    invoke-static {v6}, Lcom/google/android/material/color/utilities/ColorUtils;->argbFromLinrgb([D)I
    ...
    .line 29
    sget-object v13, Lcom/google/android/material/color/utilities/HctSolver;->Y_FROM_LINRGB:[D

    aget-wide v16, v13, v21
    ...
    .line 34
    invoke-static/range {v18 .. v19}, Lcom/google/android/material/color/utilities/HctSolver;->isBounded(D)Z
    ...
    .line 36
    invoke-static/range {v16 .. v17}, Lcom/google/android/material/color/utilities/HctSolver;->isBounded(D)Z
    ...
    .line 40
    :goto_9
    aget-wide v15, v4, v21

    cmpg-double v13, v15, v22
    ...
    .line 41
    :cond_11
    invoke-static {v4}, Lcom/google/android/material/color/utilities/HctSolver;->hueOf([D)D
    ...
    .line 57
    sget-object v12, Lcom/google/android/material/color/utilities/HctSolver;->CRITICAL_PLANES:[D
    ...
    .line 60
    invoke-static {v13}, Lcom/google/android/material/color/utilities/HctSolver;->hueOf([D)D
