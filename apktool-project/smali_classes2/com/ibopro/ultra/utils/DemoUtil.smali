.class public final Lcom/ibopro/ultra/utils/DemoUtil;
...
.method public static buildRenderersFactory(Landroid/content/Context;Z)Lcom/google/android/exoplayer2/RenderersFactory;
    ...
    .line 1
    invoke-static {}, Lcom/ibopro/ultra/utils/DemoUtil;->useExtensionRenderers()Z
...
.method public static declared-synchronized getDataSourceFactory(Landroid/content/Context;Z)Lcom/google/android/exoplayer2/upstream/DataSource$Factory;
    ...
    const-class v0, Lcom/ibopro/ultra/utils/DemoUtil;

    monitor-enter v0

    .line 1
    :try_start_0
    sget-object v1, Lcom/ibopro/ultra/utils/DemoUtil;->dataSourceFactory:Lcom/google/android/exoplayer2/upstream/DataSource$Factory;
    ...
    .line 4
    invoke-static {p0, p1}, Lcom/ibopro/ultra/utils/DemoUtil;->getHttpDataSourceFactory(Landroid/content/Context;Z)Lcom/google/android/exoplayer2/upstream/HttpDataSource$Factory;
    ...
    .line 5
    invoke-static {p0}, Lcom/ibopro/ultra/utils/DemoUtil;->getDownloadCache(Landroid/content/Context;)Lcom/google/android/exoplayer2/upstream/cache/Cache;

    move-result-object p0

    invoke-static {v1, p0}, Lcom/ibopro/ultra/utils/DemoUtil;->buildReadOnlyCacheDataSource(Lcom/google/android/exoplayer2/upstream/DataSource$Factory;Lcom/google/android/exoplayer2/upstream/cache/Cache;)Lcom/google/android/exoplayer2/upstream/cache/CacheDataSource$Factory;

    move-result-object p0

    sput-object p0, Lcom/ibopro/ultra/utils/DemoUtil;->dataSourceFactory:Lcom/google/android/exoplayer2/upstream/DataSource$Factory;

    .line 6
    :cond_0
    sget-object p0, Lcom/ibopro/ultra/utils/DemoUtil;->dataSourceFactory:Lcom/google/android/exoplayer2/upstream/DataSource$Factory;
    :try_end_0
...
.method private static declared-synchronized getDatabaseProvider(Landroid/content/Context;)Lcom/google/android/exoplayer2/database/DatabaseProvider;
    ...
    .line 1
    :try_start_0
    sget-object v1, Lcom/ibopro/ultra/utils/DemoUtil;->databaseProvider:Lcom/google/android/exoplayer2/database/DatabaseProvider;
    ...
    sput-object v1, Lcom/ibopro/ultra/utils/DemoUtil;->databaseProvider:Lcom/google/android/exoplayer2/database/DatabaseProvider;

    .line 3
    :cond_0
    sget-object p0, Lcom/ibopro/ultra/utils/DemoUtil;->databaseProvider:Lcom/google/android/exoplayer2/database/DatabaseProvider;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private static declared-synchronized getDownloadCache(Landroid/content/Context;)Lcom/google/android/exoplayer2/upstream/cache/Cache;
    ...
    .line 1
    :try_start_0
    sget-object v1, Lcom/ibopro/ultra/utils/DemoUtil;->downloadCache:Lcom/google/android/exoplayer2/upstream/cache/Cache;
    ...
    .line 3
    invoke-static {p0}, Lcom/ibopro/ultra/utils/DemoUtil;->getDownloadDirectory(Landroid/content/Context;)Ljava/io/File;
    ...
    .line 5
    invoke-static {p0}, Lcom/ibopro/ultra/utils/DemoUtil;->getDatabaseProvider(Landroid/content/Context;)Lcom/google/android/exoplayer2/database/DatabaseProvider;
    ...
    sput-object v2, Lcom/ibopro/ultra/utils/DemoUtil;->downloadCache:Lcom/google/android/exoplayer2/upstream/cache/Cache;

    .line 6
    :cond_0
    sget-object p0, Lcom/ibopro/ultra/utils/DemoUtil;->downloadCache:Lcom/google/android/exoplayer2/upstream/cache/Cache;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private static declared-synchronized getDownloadDirectory(Landroid/content/Context;)Ljava/io/File;
    ...
    .line 1
    :try_start_0
    sget-object v1, Lcom/ibopro/ultra/utils/DemoUtil;->downloadDirectory:Ljava/io/File;
    ...
    sput-object v1, Lcom/ibopro/ultra/utils/DemoUtil;->downloadDirectory:Ljava/io/File;
    ...
    sput-object p0, Lcom/ibopro/ultra/utils/DemoUtil;->downloadDirectory:Ljava/io/File;

    .line 4
    :cond_0
    sget-object p0, Lcom/ibopro/ultra/utils/DemoUtil;->downloadDirectory:Ljava/io/File;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static declared-synchronized getHttpDataSourceFactory(Landroid/content/Context;Z)Lcom/google/android/exoplayer2/upstream/HttpDataSource$Factory;
    ...
    .line 1
    :try_start_0
    sget-object v1, Lcom/ibopro/ultra/utils/DemoUtil;->httpDataSourceFactory:Lcom/google/android/exoplayer2/upstream/HttpDataSource$Factory;
    ...
    sput-object v1, Lcom/ibopro/ultra/utils/DemoUtil;->httpDataSourceFactory:Lcom/google/android/exoplayer2/upstream/HttpDataSource$Factory;

    .line 6
    :cond_0
    sget-object p0, Lcom/ibopro/ultra/utils/DemoUtil;->httpDataSourceFactory:Lcom/google/android/exoplayer2/upstream/HttpDataSource$Factory;
    ...
    sput-object p0, Lcom/ibopro/ultra/utils/DemoUtil;->httpDataSourceFactory:Lcom/google/android/exoplayer2/upstream/HttpDataSource$Factory;
